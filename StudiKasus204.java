public class StudiKasus204{
    public static vooid main(String[] args) {
        ...
        luas_tanah_tdk_digunakan = luas_tanah - (luas_kolam_lingkaran + luas_kolam_persegi);
        ...
        System.out.println("Luas tanah Pak Tono yang tidak digunakan adalah "+luas_tanah_tdk_digunakan);
    }
}